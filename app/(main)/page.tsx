        ...
        <div className="grid">
                ...
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">49</div>
                        </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Ganancia </span>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Commentarios</span>
                            <div className="text-900 font-medium text-xl">30 No leídos</div>
                        </div>
                    ...
                    <ul className="p-0 mx-0 mt-0 mb-4 list-none">
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                ...
                                <span className="text-700">
                                    {' '}
                                    ha comprado una hamburguesa artesanal <span className="text-blue-500">6$</span>
                                </span>
                            </span>
                        </li>
                        <li className="flex align-items-center py-2">
                            ...
                            <span className="text-700 line-height-3">
                                Su solicitud de encargo <span className="text-blue-500 font-medium">500$</span> ha sido iniciada.
                            </span>
                        </li>
                    </ul>
                    ...
                    <ul className="p-0 m-0 list-none">
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                ...
                                <span className="text-700">
                                    {' '}
                                    ha comprado desayuno ejecutivo <span className="text-blue-500">6.75$</span>
                                </span>
                            </span>
                        </li>
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                Jackson Benítez
                                <span className="text-700"> ha posteado una nueva pregunta acerca de un producto.</span>
                            </span>
                        </li>
                    </ul>
                </div>
