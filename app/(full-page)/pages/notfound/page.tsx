    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <img src="/demo/images/notfound/boulevar.jpg" alt="Boulevar de las frutas" className="mb-5 w-6rem flex-shrink-0" />
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                        background: 'linear-gradient(180deg, rgba(255, 0, 0, 0.4) 10%, rgba(255, 0, 0, 0) 30%)'
                    }}
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        <span className="text-red-500 font-bold text-3xl">404</span>
                        ...
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                ...
                                <span className="text-600 lg:text-lg">...</span>
                            </span>
                        </Link>
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                ...
                                <span className="text-600 lg:text-lg">boulevarsoft@gmail.com</span>
                            </span>
                        </Link>
                        <Link href="/" className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">Administración de permisos</span>
                                <span className="text-600 lg:text-lg">...</span>
                            </span>
                        </Link>
                    </div>
